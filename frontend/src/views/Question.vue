<template>
    <div class="single-question mt-2">
            ...
            <div v-else-if="showForm">
                <form class="card" @submit.prevent="onSubmit">
                    ...
                    <div class="card-block">
                        <textarea rows="5" v-model="newAnswerBody" class="form-control" placeholder="Share Your Knowledge!"></textarea>
                    </div>
        ...
        <div v-else><h1 class="error text-center" id="notfound">404 - Question Not Found</h1></div>  
        <div v-if="question" class="container">
            <AnswerComponent v-for="answer in answers" :answer="answer" :requestUser="requestUser" :key="answer.id" @delete-answer="deleteAnswer" />
            <div class="my-4"><p v-show="loadingAnswers">...loading...</p></div>
    ...
    methods: {
        ...
        getQuestionData() {
            ...
            .then(data =>{
                if (data){
                    this.question = data;
                    this.userHasAnswered = data.user_has_answerd;
